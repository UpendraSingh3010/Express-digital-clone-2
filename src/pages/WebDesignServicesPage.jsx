...
export default function WebDesignServicesPage() {
  const paragraphs = [
  "Web designing is the salient feature of digitalisation and first step towards success. It is must to engage visitors on sites for proper manoeuvre. Our team having expertise will craft your site with intelligibility and interactive.",
  "Digital world in itself is wide and competitive, as per our competence we promise to keep you on top in the achievers list. We are clear in our thoughts and have a vision which makes us unique and help to engage visitors with your brand. Fulfilling your objective is our motive and team will get in touch always till the time design are not fix as per your need.",
  "We encourage exchange of words and sharing ideas which leads to positive results. Content analysis is our impartial style of working in a project which contributes to outline the roadmap of a project.",
  ...
  {
    "num": "12",
    "label": "Websites for TOP 500 companies"
  },
  {
    "num": "17",
    "label": "Complex intranets for corporations"
  },
  {
    "num": "97",
    "label": "Popular Facebook applications"
  },
  {
    "num": "74",
    "label": "E-mail marketing strategies"
  },
  {
    "num": "36",
    "label": "Experienced Web Development Ninjas"
  }
];
  const features = [
      ...
      <section className="bg-[#1b6ba8] text-white py-14">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
          <div className="text-xs uppercase tracking-wider text-blue-200 mb-2">
            <Link to="/" className="hover:underline">Home</Link> &gt; <Link to="/services" className="hover:underline">Services</Link> &gt; <span className="text-white font-medium">Web Design Services</span>
          </div>
