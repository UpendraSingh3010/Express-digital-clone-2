...
export default function SearchEngineOptimizationServicesPage() {
  const paragraphs = [
  "To enhance the sales rate with profitability and cost efficiency it is must to have SEO which initiates effective search presence.",
  ...
  "Informative content helps in development and targeted promotions which fulfill the needs by maintaining the visibility of your web presence.",
  "It keeps your content visible to search engines. We are always prepare to boost your ranking to improve your ability",
  "SEO strategy makes more sense with link building element as it is must to build your internal link profile to add significance to your page keywords listed with search engines."
];
  const counters = [
  {
    "num": "83%",
  ...
  {
    "num": "42%",
    "label": "Bounce Rate - Decrease"
  },
  {
    "num": "38%",
    "label": "Average Visit Duration - Increase"
  },
  {
    "num": "21%",
    "label": "Pages Per Session - Increase"
  }
];
  const features = [
  "Organic Search",
      ...
      <section className="bg-[#1b6ba8] text-white py-14">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
          <div className="text-xs uppercase tracking-wider text-blue-200 mb-2">
            <Link to="/" className="hover:underline">Home</Link> &gt; <Link to="/services" className="hover:underline">Services</Link> &gt; <span className="text-white font-medium">Search Engine Optimization & Marketing</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-6">
              <h2 className="text-2xl sm:text-3xl font-light text-gray-800 tracking-tight">
                About Search Engine Optimization & Marketing
              </h2>
